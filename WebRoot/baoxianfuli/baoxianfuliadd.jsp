...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <form method="post"   action="method!baoxianfuliadd2">
    ...
    <tr>
     ...
     <tr>
      ...
      <td class="td_bg" ><input type="text" name="mingchen" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">金额</td>
      <td class="td_bg" ><input type="text" name="gongzi" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">月份</td>
      <td class="td_bg" ><input type="text" name="yuefen" /></td>
