...
<br/>
<form action="method!baoxianfulilist" method="post">
<div align="left">
...
<a href="method!baoxianfuliadd"><span style="font-size: 25px;">添加保险福利</span></a>
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <a href="method!baoxianfuliupdate?id=${bean.id }"><span style="font-size: 15px;">更新保险福利</span></a>
      <a href="method!baoxianfulidelete?id=${bean.id }"><span style="font-size: 15px;">删除保险福利</span></a>
      </td>
    </tr>
    </c:forEach>
