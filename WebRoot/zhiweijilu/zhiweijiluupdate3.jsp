...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="xingming" value="${bean.xingming }" readonly="readonly"/></td>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="addresss" value="${bean.addresss }" readonly="readonly"/></td>
    ...
    <tr>
      ...
      <td class="td_bg" ><textarea rows="7" cols="50" name="yingpingjieguo" readonly="readonly">${bean.yingpingjieguo }</textarea>
      </td>
