...
<br/>
<form action="method!zhiweilist" method="post">
<div align="left">
...
<a href="method!zhiweiadd"><span style="font-size: 25px;">添加新的职位</span></a>
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <a href="method!zhiweiupdate?id=${bean.id }"><span style="font-size: 15px;">更新职位</span></a>
      <a href="method!zhiweidelete?id=${bean.id }"><span style="font-size: 15px;">删除职位</span></a>
      </td>
    </tr>
    </c:forEach>
