...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="zhiweimingchen" value="${bean.zhiweimingchen }" readonly="readonly"/></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">招聘人数</td>
      <td class="td_bg" ><input type="text" name="zhaopinrenshi" value="${bean.zhaopinrenshi }" readonly="readonly" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">备注</td>
      <td class="td_bg" ><textarea rows="7" cols="50"  name="beizhu"  readonly="readonly">${bean.beizhu }</textarea>
      </td>
