...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="peixunjihua" value="${bean.peixunjihua }" readonly="readonly"/></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训周期</td>
      <td class="td_bg" ><input type="text" name="peixunzhouqi" value="${bean.peixunzhouqi }" readonly="readonly"/></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训地点</td>
      <td class="td_bg" ><input type="text" name="peixundidian" value="${bean.peixundidian }" readonly="readonly"/></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训内容</td>
      <td class="td_bg" ><textarea rows="7" cols="50" name="peixunneirong" readonly="readonly">${bean.peixunneirong }</textarea>
      </td>
