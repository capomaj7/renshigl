...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <form method="post"   action="method!peixunadd2">
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="peixunjihua" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训周期</td>
      <td class="td_bg" ><input type="text" name="peixunzhouqi" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训地点</td>
      <td class="td_bg" ><input type="text" name="peixundidian" /></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">培训内容</td>
      <td class="td_bg" ><textarea rows="7" cols="50" name="peixunneirong"></textarea>
      </td>
