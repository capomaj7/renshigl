...
<title>门面管理</title>
<link href="${ctx }/Images/css1/css.css" rel="stylesheet" type="text/css">
</head>
...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <form method="post"   action="${ctx }/menmianAction_addMenmian">
    <tr>
      <td class="td_bg"  height="23">分店编号</td>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="address" /></td>
    </tr>
