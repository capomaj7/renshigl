...
<h1><input type="button" onclick="switchBar(this)" value="关闭左边管理菜单" name="SubmitBtn"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="bianhao" value="${bean.bianhao }" readonly="readonly"/></td>
     
    </tr>
    <tr>
      <td class="td_bg"  height="23">部门名称</td>
      <td class="td_bg" ><input type="text" name="name" value="${bean.name }" readonly="readonly"/></td>
